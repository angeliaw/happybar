...
#define kOnImageName @"settings.png"
#define kOffImageName @"settings.png"
...
- (void)setOn:(BOOL)on animated:(BOOL)animated {
    ...
    if (_on) {
        ...
        [_wheelButton setTransform:CGAffineTransformMakeRotation(80)];
        ...
        [UIView setAnimationBeginsFromCurrentState:YES];
        [UIView setAnimationDuration:1];
        [_wheelButton setTransform:CGAffineTransformMakeRotation(-30)];
        [UIView commitAnimations];
...
CGFloat const kApertureAngle = 60.0f;
